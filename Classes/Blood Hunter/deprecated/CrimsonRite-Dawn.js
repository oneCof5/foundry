    ...
    buttons: {
      Ok: {
        ...
        callback: (html) => {
          ...
          // inform the player
          ui.notifications.notify("Rite of the Dawn (Activates): "+ copy_item.name + " is empowered.");
...
if (args[0] === "off") {
  ...
  ui.notifications.notify("Rite of the Dawn (Fades): "+ copy_item.name + " returns to normal.");
